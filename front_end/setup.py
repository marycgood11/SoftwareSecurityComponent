...
class UI_Setup(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.frames = {}
        for F in (welcomepage.WelcomePage, homepage.HomePage, scenarios.Scenario1, scenarios.Scenario2, scenarios.Scenario3, scenarios.Scenario4, scenarios.Scenario5, scenarios.Scenario6, scenarios.Scenario7, scenarios.Scenario8, scenarios.Scenario9, score.Score):
